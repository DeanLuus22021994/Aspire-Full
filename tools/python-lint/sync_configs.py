...
LINT_ROOTS_FILE = REPO_ROOT / ".config" / "python-lint-roots.txt"
LINT_EXCLUDE_FILE = REPO_ROOT / ".config" / "python-lint-excludes.txt"
...
def write_lint_roots() -> None:
    """Persist the default directories that contain our first-party Python code."""
