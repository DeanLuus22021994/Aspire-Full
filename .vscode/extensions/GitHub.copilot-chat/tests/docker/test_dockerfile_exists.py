#!/usr/bin/env python3
"""Docker validation for the GitHub.copilot-chat extension."""
...
def test_dockerfile_exists() -> None:
    """Ensure the GitHub Copilot Chat Dockerfile is present for builds."""
...
def test_dockerfile_declares_base_image() -> None:
    """Ensure the Dockerfile declares a base image."""
    dockerfile = _dockerfile_path()
