#!/usr/bin/env python3
"""Helper metadata validation for the GitHub.vscode-pull-request-github extension."""
...
def _load_helper() -> ModuleType:
    ...
    spec = importlib.util.spec_from_file_location("github_pr_helper", helper_path)
    if spec is None or spec.loader is None:
        raise RuntimeError("Unable to load GitHub.vscode-pull-request-github helper module")
