#!/usr/bin/env python3
"""Docker validation for the EditorConfig.EditorConfig extension."""
...
def test_dockerfile_exists() -> None:
    """Ensure the EditorConfig Dockerfile is available for local builds."""
...
def test_dockerfile_declares_base_image() -> None:
    """Ensure the Dockerfile contains a base image directive."""
    dockerfile = _dockerfile_path()
