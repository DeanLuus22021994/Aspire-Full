#!/usr/bin/env python3
"""Tensor-optimized helper for the GitHub.copilot extension.
...
# Extension metadata
EXTENSION_ID: Final[str] = "GitHub.copilot"
IS_GPU_REQUIRED: Final[bool] = True  # Copilot benefits from GPU acceleration
...
def get_context() -> ExtensionContext:
    """Return tensor-optimized context for GitHub Copilot extension."""
