#!/usr/bin/env python3
"""Docker validation for the ms-windows-ai-studio.windows-ai-studio extension."""
...
def test_dockerfile_exists() -> None:
    """Ensure the Windows AI Studio Dockerfile is present for builds."""
...
def test_dockerfile_declares_base_image() -> None:
    """Ensure the Dockerfile declares a base image for AI workloads."""
    dockerfile = _dockerfile_path()
