#!/usr/bin/env python3
"""Docker validation for the streetsidesoftware.code-spell-checker extension."""
...
def test_dockerfile_exists() -> None:
    """Ensure the Code Spell Checker Dockerfile is present for builds."""
...
def test_dockerfile_declares_base_image() -> None:
    """Ensure the Dockerfile declares a base image for builds."""
    dockerfile = _dockerfile_path()
