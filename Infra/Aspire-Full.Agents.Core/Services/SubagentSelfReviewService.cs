...
namespace Aspire_Full.Agents.Core.Services;

/// <summary>
/// Implementation of <see cref="ISubagentSelfReviewService"/> for generating
/// retrospectives and delegation plans from subagent updates.
/// </summary>
public sealed class SubagentSelfReviewService : ISubagentSelfReviewService
{
    ...
    public SubagentSelfReviewService(ISubagentCatalog catalog)
        : this(catalog, TimeProvider.System)
    {
    }

    public SubagentSelfReviewService(ISubagentCatalog catalog, TimeProvider timeProvider)
    {
        _catalog = catalog ?? throw new ArgumentNullException(nameof(catalog));
        _timeProvider = timeProvider ?? throw new ArgumentNullException(nameof(timeProvider));
    }

    public SubagentDefinition GetDefinition(SubagentRole role) => _catalog.Get(role);
