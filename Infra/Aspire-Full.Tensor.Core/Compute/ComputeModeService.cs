...
{
    /// <summary>Current compute mode. Can be toggled at runtime.</summary>
    ...
    /// <summary>Fraction of GPU memory to allocate (0.0-1.0).</summary>
    ...
    /// <summary>Maximum batch size for batched operations.</summary>
