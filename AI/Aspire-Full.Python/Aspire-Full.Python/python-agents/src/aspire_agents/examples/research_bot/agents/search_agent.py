...
INSTRUCTIONS = (
    ...
    "produce a concise summary of the results. The summary must be 2-3 paragraphs and less "
    "than 300 words. Capture the main points. Write succinctly, no need to have complete "
    "sentences or good grammar. This will be consumed by someone synthesizing a report, so "
    "its vital you capture the essence and ignore any fluff. Do not include any additional "
