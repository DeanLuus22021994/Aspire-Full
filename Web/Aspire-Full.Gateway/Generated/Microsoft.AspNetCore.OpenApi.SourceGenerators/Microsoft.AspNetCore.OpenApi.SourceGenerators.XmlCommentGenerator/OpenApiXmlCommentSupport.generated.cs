...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"T:Aspire_Full.Embeddings.IEmbeddingService", new XmlComment(@"Service for generating text embeddings using Microsoft.Extensions.AI.
...
Optimized for GPU-accelerated workloads with SIMD support.", null, null, null, null, false, null, null, null));
            cache.Add(@"M:Aspire_Full.Embeddings.IEmbeddingService.GenerateEmbeddingAsync(System.String,System.Threading.CancellationToken)", new XmlComment(@"Generate embeddings for a single text input.", null, null, null, null, false, null, null, null));
            cache.Add(@"M:Aspire_Full.Embeddings.IEmbeddingService.GenerateEmbeddingsAsync(System.Collections.Generic.IList{System.String},System.Threading.CancellationToken)", new XmlComment(@"Generate embeddings for multiple text inputs (batch processing for GPU efficiency).", null, null, null, null, false, null, null, null));
            cache.Add(@"M:Aspire_Full.Embeddings.IEmbeddingService.GenerateEmbeddingsStreamAsync(System.Collections.Generic.IEnumerable{System.String},System.Threading.CancellationToken)", new XmlComment(@"Generate embeddings as async enumerable for streaming large batches.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Embeddings.IEmbeddingService.EmbeddingDimensions", new XmlComment(@"Get the dimension size of the embedding model.", null, null, null, null, false, null, null, null));
            cache.Add(@"T:Aspire_Full.Embeddings.EmbeddingService", new XmlComment(@"Default implementation of IEmbeddingService using Microsoft.Extensions.AI.
Uses IEmbeddingGenerator for modern .NET 10 compatible embedding generation.", null, null, null, null, false, null, null, null));
...
Optimized for GPU-accelerated workloads with SIMD support.", null, null, null, null, false, null, null, null));
            ...
            cache.Add(@"T:Aspire_Full.Gateway.Models.User", new XmlComment(@"User entity representing both standard users and administrators.
Supports soft delete (downsert) and upsert patterns.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.Email", new XmlComment(@"Unique email address for the user.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.DisplayName", new XmlComment(@"Display name shown in the UI.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.Role", new XmlComment(@"User's role: User or Admin.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.IsActive", new XmlComment(@"Whether the user account is active (false = soft deleted/downserted).", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.CreatedAt", new XmlComment(@"When the user was created.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.UpdatedAt", new XmlComment(@"When the user was last updated.", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.DeletedAt", new XmlComment(@"When the user was soft deleted (null if active).", null, null, null, null, false, null, null, null));
            cache.Add(@"P:Aspire_Full.Gateway.Models.User.LastLoginAt", new XmlComment(@"Last login timestamp.", null, null, null, null, false, null, null, null));
    ...
    {
        [global::System.Runtime.CompilerServices.InterceptsLocationAttribute(1, "cmNn/aEApj7tdn+dGARO0yoCAABQcm9ncmFtLmNz")]
