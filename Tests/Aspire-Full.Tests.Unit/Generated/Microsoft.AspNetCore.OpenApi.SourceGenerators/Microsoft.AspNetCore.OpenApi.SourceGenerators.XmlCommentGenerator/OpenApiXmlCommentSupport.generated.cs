...
namespace Microsoft.AspNetCore.OpenApi.Generated
{
    ...
    file static class XmlCommentCache
    {
        ...
        private static Dictionary<string, XmlComment> GenerateCacheEntries()
        {
            ...
            cache.Add(@"T:Aspire_Full.Tests.Unit.Controllers.ItemsControllerTests", new XmlComment(@"Unit tests for ItemsController.
Tests all CRUD operations with in-memory database.", null, null, null, null, false, null, null, null));
            cache.Add(@"T:Aspire_Full.Tests.Unit.Controllers.UsersControllerTests", new XmlComment(@"Tests for the user management kernel (upsert/downsert soft delete flow).
Leverages the shared test root (Aspire-Full.Tests.Unit) with the in-memory AppDbContext.", null, null, null, null, false, null, null, null));
            cache.Add(@"T:Aspire_Full.Tests.Unit.Data.AppDbContextTests", new XmlComment(@"Unit tests for AppDbContext.
Tests entity configuration and database operations.", null, null, null, null, false, null, null, null));
            cache.Add(@"T:Aspire_Full.Tests.Unit.Models.ItemModelTests", new XmlComment(@"Unit tests for Item model and DTOs.", null, null, null, null, false, null, null, null));
            cache.Add(@"M:Aspire_Full.Tests.Unit.Fixtures.TestDbContextFactory.CreateContext(System.String)", new XmlComment(@"Creates a new in-memory database context for testing.", null, null, @"A configured AppDbContext with in-memory provider.", null, false, null, [new XmlParameterComment(@"databaseName", @"Optional unique database name for isolation.", null, false)], null));
            cache.Add(@"M:Aspire_Full.Tests.Unit.Fixtures.TestDbContextFactory.CreateSeededContext(System.String)", new XmlComment(@"Creates a context and seeds it with test data.", null, null, null, null, false, null, null, null));
            cache.Add(@"M:Aspire_Full.Tests.Unit.Fixtures.TestDbContextFactory.SeedTestData(Aspire_Full.Api.Data.AppDbContext)", new XmlComment(@"Seeds the context with standard test data.", null, null, null, null, false, null, null, null));
